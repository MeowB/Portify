...
const getUploadUrl = async (userId: string, title: string, imageType: string, mimeType: string): Promise<{ uploadUrl: string, imageName: string } | undefined> => {
	try {
...
const handleImageUpload = async (file: File, userId: string, title: string, imageType: string): Promise<string | undefined> => {
  try {
